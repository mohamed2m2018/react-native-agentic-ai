...
This is the companion MCP server for the [`@mobileai/react-native`](https://www.npmjs.com/package/@mobileai/react-native) package, the React Native SDK for MobileAI Cloud by Twomilia.
