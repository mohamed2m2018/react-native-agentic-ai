  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.pointsCard}>
        ...
        <Text style={styles.pointsSub}>50 points until your next free dish</Text>
      </View>
      ...
      >
        ...
        <View style={{ flex: 1 }}>
          ...
          <Text style={styles.redeemSub}>Use your points for free dishes & gift cards</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  pointsCard: {
    padding: 24, borderRadius: 16, backgroundColor: 'rgba(40,167,69,0.08)',
    alignItems: 'center', marginBottom: 24, borderWidth: 1, borderColor: 'rgba(40,167,69,0.15)',
  },
  pointsLabel: { fontSize: 14, color: '#28a745', fontWeight: '600', marginBottom: 4 },
  pointsValue: { fontSize: 48, fontWeight: 'bold', color: '#28a745' },
  pointsSub: { fontSize: 13, color: '#6c757d', marginTop: 4 },
  sectionTitle: { fontSize: 18, fontWeight: '600', color: '#1a1a2e', marginBottom: 12, marginTop: 8 },
  earnCard: {
    padding: 16, borderRadius: 12, backgroundColor: '#fff', gap: 10, marginBottom: 24,
  ...
  redeemButton: {
    ...
    backgroundColor: '#fff', marginTop: 24, gap: 14,
    shadowColor: '#000', shadowOpacity: 0.03, shadowRadius: 4, shadowOffset: { width: 0, height: 2 },
  },
