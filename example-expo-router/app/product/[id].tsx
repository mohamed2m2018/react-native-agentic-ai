...
const PRODUCTS: Record<string, { name: string; price: number; category: string; description: string; specs: string[] }> = {
  ...
  '2': { name: 'Running Shoes', price: 129.99, category: 'Footwear', description: 'Lightweight running shoes with responsive cushioning and breathable mesh upper for maximum comfort.', specs: ['Sizes 6-13', 'Leather Upper', 'Rubber Outsole', 'Responsive Foam'] }, // 🐛 BUG: spec says 'Leather Upper' but description says 'mesh upper'
